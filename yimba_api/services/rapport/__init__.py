...
from yimba_api.services.rapport import api
from yimba_api.config import service as service_config


SETTINGS: service_config.Rapport = service_config.get("rapport")


app: FastAPI = FastYimbaAPI(
    title=SETTINGS.title, docs_url=SETTINGS.docs_url, openapi_url=SETTINGS.openapi_url
)
app.mount("/static", StaticFiles(directory="yimba_api/static"), name="static")
